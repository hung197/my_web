                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertOrderDetail.htm"> Thêm OrderDetail</a>
                                ...
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listOrDe}" var="listOrDe">
                                            <tr>
                                                <td>${listOrDe.id}</td>
                                                <td>${listOrDe.productDetail.product.productName}</td>
                                                <td>${listOrDe.orderPro.orderId}</td>
                                                <td>${listOrDe.quantity}</td>
                                                <td>${listOrDe.amount}</td>
                                                <td>${listOrDe.detailStatus}</td>                                               
                                                <td> 
