    ...
    <section class="content">
     ...
     <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
       <f:form action="updateCategory.htm" commandName="caUpdate" method ="POST">
            <table border="1">
                <tr>
                    <td>Category Id</td>
                    <td><f:input path="categoryId" readonly="true"/> </td>
                </tr>
                <tr>
                    <td>Category Name</td>
                ...
                <tr>
                    <td>PriotityCategory</td>
                    <td><f:input path="priotityCategory"/></td>
                </tr>
                <tr>
                    <td>Descriptions</td>
