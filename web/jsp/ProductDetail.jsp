<%-- 
    ...
    Created on : Oct 6, 2020, 3:55:37 PM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertProductDetail.htm"> Thêm ProductDetail</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listProDe}" var="listProDe">
                                            <tr>
                                                <td>${listProDe.productDetailId}</td>
                                                <td>${listProDe.product.productName}</td>
                                                <td>${listProDe.color.colorName}</td>
                                                <td>${listProDe.rom.romName}</td>
                                                <td>${listProDe.imagesLink}</td>
                                                <td>${listProDe.created}</td>
                                                <td>${listProDe.discount}</td>
                                                <td>${listProDe.viewPro}</td>
                                                <td>${listProDe.price}</td>
                                                <td>${listProDe.quantity}</td>
                                                <td>${listProDe.productStatus}</td>

                                                <td> 
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/productDetailController/initUpdateProductDetail.htm?productDetailId=${listProDe.productDetailId}">Sửa </a>
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/productDetailController/deleteProductDetail.htm?productDetailId=${listProDe.productDetailId}">Xóa </a>
                                                </td>
                                        <a href="../../src/java/bkap/controller/productDetailIdController.java"></a>
                                        </tr>
