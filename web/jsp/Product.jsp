<%-- 
    Document   : Product
    Created on : Oct 23, 2020, 7:52:31 AM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertPro.htm"> Thêm Product</a>
                                ...
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listPro}" var="listPro">
                                            <tr>
                                                <td>${listPro.productId}</td>
                                                <td>${listPro.productName}</td>
                                                <td>${listPro.category.categoryName}</td>
                                                <td>${listPro.title}</td>
                                                <td>${listPro.descriptions}</td>
                                                <td>${listPro.productStatus}</td>

                                                <td> 

                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/productController/initUpdateProduct.htm?productId=${listPro.productId}">Sửa </a>
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/productController/deleteProduct.htm?productId=${listPro.productId}">Xóa </a>
                                                </td>
