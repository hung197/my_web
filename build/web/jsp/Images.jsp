<%-- 
    Document   : Images
    Created on : Oct 10, 2020, 3:37:34 PM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertImages.htm"> Thêm Images</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listImag}" var="listImag">
                                            <tr>
                                                <td>${listImag.imagesId}</td>
                                                <td>${listImag.productDetail.productDetailId}</td>
                                                <td>${listImag.imagesLink}</td>
                                                <td>${listImag.imagesStatus}</td>
                                                

                                                <td> 

                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/imagesComntroller/initUpdateImages.htm?imagesId=${listImag.imagesId}">Sửa </a>
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/imagesComntroller/deleteImages.htm?imagesId=${listImag.imagesId}">Xóa </a>
                                                </td>
