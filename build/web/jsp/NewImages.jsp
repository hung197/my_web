<%-- 
    Document   : NewImages
    Created on : Oct 10, 2020, 3:52:27 PM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Thêm Images</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <f:form action="insertImages.htm" commandName="ImNew">
                                <table border="1">
                                    ...
                                    <tr>
                                        ...
                                        <td><f:select path="productDetail.productDetailId">
                                                ...
                                                <c:forEach items="${listProDe}" var="cat">
                                                    <f:option value="${cat.productDetailId}">${cat.product.productName}</f:option>
                                                </c:forEach>
