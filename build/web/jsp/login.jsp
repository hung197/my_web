<%-- 
    Document   : login
    Created on : Nov 3, 2020, 7:59:40 PM
    Author     : Windows 10
--%>
...
<body>
    ...
    <div class="wrapper">
                        ...
                        <form action="login.htm" method="POST">
                            <div class="login-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <button class="jb-login_btn" type="submit">Login</button>
                                    </div>
                                </div>
                            </div>
                        </form>
      ...
      <a  class="btn btn-success" href="initInsertAdmin.htm">Thêm Mới Tài Khoản</a>
