<%-- 
    Document   : ShipType
    Created on : Oct 5, 2020, 9:50:30 AM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertShiptype.htm"> Thêm ShipType</a>
                                ...
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listShip}" var="listShip">
                                            <tr>
                                                <td>${listShip.shipId}</td>
                                                <td>${listShip.shipName}</td>
                                                <td>${listShip.fees}</td>
                                                <td>${listShip.shipStatus}</td>
                                                <td> 

                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/shiptypeController/initUpdateShipType.htm?shipId=${listShip.shipId}">Sửa </a>
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/shiptypeController/deleteShipType.htm?shipId=${listShip.shipId}">Xóa </a>
                                                </td>
