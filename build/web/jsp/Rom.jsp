<%-- 
    Document   : Rom
    Created on : Oct 3, 2020, 8:42:02 AM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertRom.htm"> Thêm Rom</a>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listR}" var="listR">
                                            <tr>
                                                <td>${listR.romId}</td>
                                                <td>${listR.romName}</td>
                                                <td>${listR.romStatus}</td>
                                                

                                                <td> 

                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/romController/initUpdateRom.htm?romId=${listR.romId}">Sửa </a>
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/romController/deleteRom.htm?romId=${listR.romId}">Xóa </a>
                                                </td>
