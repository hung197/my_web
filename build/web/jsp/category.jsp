<%-- 
    Document   : category
    Created on : Sep 18, 2020, 3:42:24 PM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertCategory.htm"> Thêm Category</a>
                                ...
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listCa}" var="listCa">
                                            <tr>
                                                <td>${listCa.categoryId}</td>
                                                <td>${listCa.categoryName}</td>
                                                <td>${listCa.priotityCategory}</td>
                                                <td>${listCa.descriptions}</td>
                                                <td>${listCa.parentId}</td>
                                                <td>${listCa.catStatus}</td>

                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateCategory.htm?categoryId=${listCa.categoryId}">Sửa </a>
                                                    <a class="btn btn-success" href="deleteCategory.htm?categoryId=${listCa.categoryId}">Xóa </a>
                                                </td>
