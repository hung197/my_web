<%-- 
    Document   : OrderPro
    Created on : Oct 11, 2020, 7:04:44 AM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertOrder.htm"> Thêm Order</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listOr}" var="listOr">
                                            <tr>
                                                <td>${listOr.orderId}</td>
                                                <td>${listOr.users.userName}</td>
                                                <td>${listOr.created}</td>
                                                <td>${listOr.totalAmount}</td>
                                                <td>${listOr.orderDetail}</td>
                                                 <td>${listOr.shipType.shipName}</td>
                                                <td>${listOr.orderStatus}</td>

                                                <td> 
                                               
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/orderController/initUpdateOrderPro.htm?orderId=${listOr.orderId}">Sửa </a>
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/productController/deleteProduct.htm?orderId=${listOr.orderId}">Xóa </a>
                                                </td>
