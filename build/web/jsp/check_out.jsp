...
<!-- Mirrored from demo.hasthemes.com/jobaria-preview-v2/jobaria/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Aug 2020 11:38:09 GMT -->
<head>
    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <title>Checkout || Jobaria - Digital Products Store eCommerce Bootstrap 4 Template</title>
                            ...
                            <div class="checkbox-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="checkout-form-list">
                                            ...
                                            <input placeholder="Pass" type="pass">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="checkout-form-list">
                                ...
                                <div class="different-address">
                                    ...
                                    <div id="ship-box-info" class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="checkout-form-list">
                                                <label>PassUser <span class="required">*</span></label>
                                                <input placeholder="pass" type="pass">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listCart}" var="cart">
                                                <tr>
                                                    ...
                                                    <td class="plantmore-product-price"><span class="amount">${cart.productDetail.price}</span></td>

                                                    <td class="plantmore-product-quantity">
                                                <input value="${cart.quantity}" type="number" name="quantity"/>
                                            </td>
                                                    <td class="product-subtotal"><span class="amount">${cart.quantity*cart.productDetail.price}</span></td>
                                                    <td class="plantmore-product-remove"><a href="deleteCart.htm?productDetail=${cart.productDetail.productDetailId}"><i class="fa fa-times"></i></a></td>
                            ...
                            <div class="payment-method">
                                <div class="payment-accordion">
                                    ...
                                    <div class="order-button-payment">
                                        <a  class="btn btn-success" href="orderPrpreOrderProductoduct.htm" type="submit" >Place order</a>
