<%-- 
    Document   : Color
    Created on : Oct 2, 2020, 10:44:48 PM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertColor.htm"> Thêm Color</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listCl}" var="listCl">
                                            <tr>
                                                <td>${listCl.colorId}</td>
                                                <td>${listCl.colorName}</td>
                                                <td>${listCl.colorStatus}</td>
                                                

                                                <td> 

                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/colorController/initUpdateColor.htm?colorId=${listCl.colorId}">Sửa </a>
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/colorController/deleteColor.htm?colorId=${listCl.colorId}">Xóa </a>
                                                </td>
