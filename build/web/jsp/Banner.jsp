<%-- 
    Document   : Banner
    Created on : Oct 10, 2020, 5:10:45 PM
    Author     : Windows 10
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertBanner.htm"> Thêm Banner</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listBan}" var="listBan">
                                            <tr>
                                                <td>${listBan.bannerId}</td>
                                                <td>${listBan.bannerName}</td>
                                                <td>${listBan.bannerLink}</td>
                                                <td>${listBan.images.imagesLink}</td>
                                                <td>${listBan.bannerStatus}</td>                                        

                                                <td> 

                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/bannerController/initUpdateBanner.htm?bannerId=${listBan.bannerId}">Sửa </a>
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/bannerController/deleteBanner.htm?bannerId=${listBan.bannerId}">Xóa </a>
                                                </td>
